...
public class SaveData {
   ...
   */
   ...
   // OBS: It's important to include an empty constructor, that can serve as a default
   ...
   public ProgressValues getProgValuesFor(int saveNr) {
      switch (saveNr) {
         case 1 : return progValues1;
         case 2 : return progValues2;
         case 3 : return progValues3;
         default : throw new IllegalArgumentException("No progressValues for saveNr " + saveNr);
      }
   }
}
