...
public class FlyLevelInfo {
   private int[] bgImgHeights = { 7600, 10740, 9750, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200 };
   private float[] resetPoints = { 20f, 1300f, 1000f, 20f, 20f, 20f, 20f, 20f, 20f, 20f, 20f, 20f, 20f, 20f };
   private float[] checkPoints = { 99999f, 13500f, 11950f, 99999f, 99999f, 99999f, 99999f, 99999f, 99999f, 99999f, 99999f, 99999f, 99999f, 99999f };
